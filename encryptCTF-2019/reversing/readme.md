In the beginning of the program, when we go to main, we get to this section, nevermind what each boxes contains yet, but from what we can see, we have multiple if else statements.
